    ...
    >
      <div
        style={{
          ...
          linear-gradient(to left, rgba(23, 28, 36, 0.7), rgba(23, 28, 36, 0) 50%) , url(${banner.src}) `,
        }}
        className={`slider-mobile-bg z-30 hidden h-[691px]  flex-col bg-transparent bg-contain bg-fixed bg-no-repeat object-contain text-xs xs:bg-cover md:flex`}
      >
      ...
      <div
        style={{
          ...
          linear-gradient(to left, rgba(23, 28, 36, 0.7), rgba(23, 28, 36, 0) 50%) , url(${mobileBanner.src}) `,
        }}
        className={`slider-mobile-bg z-30 flex h-[691px] flex-col bg-transparent bg-contain bg-fixed bg-no-repeat object-contain text-xs xs:bg-cover md:hidden`}
      >
        <div className=" flex min-h-[45vh] w-4/5 flex-col pr-8 xs:p-[56px]">
          <Image
            src={miniBanner}
